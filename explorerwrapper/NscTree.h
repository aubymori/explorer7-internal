...
static void __fastcall CNscTree_ScaleAndSetIndent(__int64 a1)
{
	...
	if (g_osVersion.BuildNumber() >= 26100 || (g_osVersion.BuildNumber() >= 22631 && g_osVersion.BuildRevision() >= 4602)) // Ittr: Handle windows 11 offset difference. Inefficient but simplified code wasnt working
		extraOffset = 16;
